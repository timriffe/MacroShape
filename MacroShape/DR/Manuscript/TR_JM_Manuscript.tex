...
Maps in general can combine layers of categorical, continuous, and
symbolic information projected to a common set of spatial coordinates. Lexis
surfaces are a graphical form used to display data on the Lexis coordinate plane, a Cartesian plane that is also a simplex relationship between age,
