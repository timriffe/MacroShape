...
shows patterns in the relationship between average remaining lifespan and the
standard deviation of remaining lifespan over age and time based on all
available populations in the \citet{HMD} from 1950 onward. The second example
shows changes in the relationship between the first and second derivative of
period fertility rates over age and time, essentially a Lexis \emph{phase
plane}, but represented as a Lexis field.
